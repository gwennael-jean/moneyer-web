...
class AccountShareNotification extends Notification implements EmailNotificationInterface
{
    ...
    public function __construct(AccountShare $accountShare, User $sharer)
    {
        ...
        parent::__construct('Account shared');
    }
    ...
    public function asEmailMessage(EmailRecipientInterface $recipient, string $transport = null): ?EmailMessage
    {
        ...
        $message->getMessage()
            ->htmlTemplate($recipient->isNewUser() ? 'emails/bank/account-share-subscribe.html.twig' : 'emails/bank/account-share.html.twig')
            ->context([
